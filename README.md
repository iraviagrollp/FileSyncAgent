...
→ Agent uses Desktop-level window search (handles child-process spawning). If it still fails after 30s, run the diagnostic: `python scripts\diagnose_fusil.py` with FUSIL open and paste the output.
