...
| Login detection | Count Edit fields: >1 = login screen, 1 = main screen | Login screen has 4 Edit fields on this machine; main screen has 1 (search box). LOGIN button lookup unreliable for 32-bit app under 64-bit UIA. |
