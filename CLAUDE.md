...
| Window detection | `Desktop(backend="uia")` scans all windows | Handles child-process spawning; PID filter removed — it excluded child-process windows, defeating the purpose |
